      ...
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-12 gap-y-12 gap-x-8 xl:gap-x-12">
          <div className="col-span-2 md:col-span-4 xl:pr-8">
            ...
            <p className="text-base leading-relaxed text-gray-600 mt-7">
              NEPAL'S NO. 1 CADET PREPARATION INSTITUTE Ready to join DIMA
              Academy and become an Army Officer?
            </p>

            <Link
              href="https://www.facebook.com/messages/t/112951606790797"
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center px-6 py-4 font-semibold text-white transition-all duration-200 bg-green-700 rounded-md hover:bg-green-800 focus:bg-green-700 mt-7"
            >
              <svg
                className="w-6 h-6"
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <p className="text-sm text-gray-600">
            © Copyright 2021, All Rights Reserved by DIMA Academy
          </p>
